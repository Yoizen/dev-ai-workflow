...
- Preserve domain-driven naming and service contracts.
- Optimize for testability and operational clarity.

## Operating rules
- Use explicit DTO validation and clear error handling.
