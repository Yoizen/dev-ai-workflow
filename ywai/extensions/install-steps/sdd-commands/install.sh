...
mkdir -p "$TARGET_PROMPTS_DIR" "$TARGET_OPENCODE_SKILLS_DIR" "$TARGET_COPILOT_AGENTS_DIR"
...
echo "Installed SDD commands to .github/prompts ($TARGET_PROMPTS_DIR), OpenCode skills ($TARGET_OPENCODE_SKILLS_DIR), and Copilot agents ($TARGET_COPILOT_AGENTS_DIR)"
