...
**This skill ALWAYS creates files on disk.** When invoked, you MUST create the spec files in the change directory. Do NOT skip file creation or resolve to a "none" mode.
