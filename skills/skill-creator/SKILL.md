...
| Project-specific | `Project-{component}` | `Project-api`, `Project-ui`, `Project-sdk-check` |
| Testing skill | `Project-test-{component}` | `Project-test-sdk`, `Project-test-api` |
...
| `license` | Yes | Always `Apache-2.0` for Project |
| `metadata.author` | Yes | `Project-cloud` |
